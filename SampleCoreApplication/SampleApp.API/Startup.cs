...
namespace SampleApp.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<SampleDbContext>(options => options.UseSqlServer(sqlConnection));
            services.AddTransient<ITeacherRepo, TeacherRepo>();
            services.AddTransient<TeacherService, TeacherService>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "MySampleAPI");
            });
